...
BCMAEP makes AI governance an operative policy that is applied in every module and audited in the capstone. The distinction is between knowing that AI exists and being able to document that a specific use of it met a defined standard.
...
- [FDA, Guiding Principles of Good AI Practice in Drug Development (January 2026, issued jointly with EMA)](https://www.fda.gov/about-fda/artificial-intelligence-drug-development/guiding-principles-good-ai-practice-drug-development)
